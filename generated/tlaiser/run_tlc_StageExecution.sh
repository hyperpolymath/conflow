...
# TLC run script for StageExecution — generated by tlaiser
...
echo "Running TLC on StageExecution.tla ..."
java -XX:+UseParallelGC -Xmx4g -jar "$TLA2TOOLS" -workers 4 -config StageExecution.cfg StageExecution.tla
