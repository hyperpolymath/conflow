...
git clone <https://github.com/hyperpolymath/conflow.git> cd conflow
...
toolbox create conflow-dev toolbox enter conflow-dev \# Install
...
conflow/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \# Library
